...
class CustomBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      ...
      itemBuilder: (BuildContext context, int index, int pageViewIndex) => Padding(
        ...
        child: Stack(children: [
          ...
          Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(image: NetworkImage(imgNewList[index]), fit: BoxFit.cover),
                  color: Colors.green,
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                AppSize.kSizedBox10h,
                HeadTitle(text: ' ₹$currentPrize', color: AppColor.kThemeBlue, fontSize: 12),
                AppSize.kSizedBox10h,
                Row(
            ...
            child: CircleAvatar(
              ...
              child: ClipRRect(
                ...
                child:
                    ...
                    //       'https://img.freepik.com/free-photo/black-woman-trendy-grey-leather-jacket-posing-beige-background-studio-winter-autumn-ecommerce_appn-look_273443-141.jpg?w=2000'),
                    //   image: NetworkImage(
                    //     imgSrc,
                    //     scale: 1,
                    //   ),
